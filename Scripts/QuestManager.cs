...
public class QuestManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log (CheckIfComplete("Angelwood"));
            MarkQuestComplete("Angelwood");
            MarkQuestIncomplete("The Novice in Town");
    ...
    public void MarkQuestComplete(string questToMark)
    {
        ...
        QuestCompleteActions.instance.PostQuestActions(questToMark);
    }
