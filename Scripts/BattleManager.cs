...
public class BattleManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            BattleStart(new string[] { "Witness", "Spotted", "Remains" }, false);
        }
                ...
                if (GameManager.instance.playerStats[i].gameObject.activeInHierarchy)
                {
                    for (int j = 0; j < playerPrefabs.Length; j++)
                    {
                        if(playerPrefabs[j].charName == GameManager.instance.playerStats[i].charName)
                        {
                            ...
                            activeBattlers[i].wpnPower = thePlayer.wpnPwer;
    ...
    public void DealDamage(int target, int movePower)
    {
        ...
        if(activeBattlers[currentTurn].wpnPower == 0 && activeBattlers[currentTurn].isPlayer)
        {
    ...
    public void Flee()
    {
        if (cannotFlee)
        {
            battleNotice.theText.text = "Can't Escape A Dragon!";
        ...
        else
        {
            ...
            {
                NextTurn();
                battleNotice.theText.text = "Couldn't Surrender!";
                battleNotice.Activate();
            }
        }
    ...
    {
        battleNotice.theText.text = "Can't Equipt Weapon Mid Battle!";
        battleNotice.Activate();
    }

    public void EquipArmorMidBattle()
    {
        battleNotice.theText.text = "Can't Equipt Armor Mid Battle!";
        battleNotice.Activate();
    }

    public void UseRingMidBattle()
    {
        battleNotice.theText.text = "Can't Use This Item!";
        battleNotice.Activate();
    }

    public void DiscardRingMidBattle()
    {
        battleNotice.theText.text = "Can't Discard This Item!";
        battleNotice.Activate();
    }
    ...
    public IEnumerator EndBattleCo()
    {
        ...
        BattleItemMenu.instance.battleItems.SetActive(false);
        BattleItemMenu.instance.itemCharChoiceMenu.SetActive(false); 
